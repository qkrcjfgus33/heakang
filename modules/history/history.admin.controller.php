<?php
     ...
     * @brief  history 모듈의 admin controller class
     **/

    class historyAdminController extends history {
         ...
         * @brief 모듈 추가
         **/
		function procHistoryAdminInsertHistory() {
         ...
         * @brief 모듈 삭제
         **/
        function procHistoryAdminDeleteHistory() {
