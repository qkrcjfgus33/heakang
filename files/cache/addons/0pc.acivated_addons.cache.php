...
$addon_file = './addons/font_nanum_gothic/font_nanum_gothic.addon.php';
if(file_exists($addon_file)){
if($rm === 'no_run_selected'){
if(!isset($ml[$_m])){
unset($addon_info); $addon_info = unserialize(base64_decode('')); @include($addon_file);
...
$addon_time_log = new stdClass();
$addon_time_log->caller = $called_position;
$addon_time_log->called = "font_nanum_gothic";
$addon_time_log->called_extension = "font_nanum_gothic";
writeSlowlog("addon",$after_time-$before_time,$addon_time_log);
$before_time = microtime(true);
$rm = '';
$ml = array(
...
$addon_file = './addons/xe-iconic/xe-iconic.addon.php';
if(file_exists($addon_file)){
if($rm === 'no_run_selected'){
if(!isset($ml[$_m])){
unset($addon_info); $addon_info = unserialize(base64_decode('')); @include($addon_file);
...
$addon_time_log = new stdClass();
$addon_time_log->caller = $called_position;
$addon_time_log->called = "xe-iconic";
$addon_time_log->called_extension = "xe-iconic";
writeSlowlog("addon",$after_time-$before_time,$addon_time_log);