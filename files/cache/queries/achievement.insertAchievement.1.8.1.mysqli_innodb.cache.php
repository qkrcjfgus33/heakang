...
$query = new Query();
$query->setQueryId("insertAchievement");
...
new InsertExpression('`achievement_srl`', ${'achievement_srl1_argument'})
,new InsertExpression('`module_srl`', ${'module_srl2_argument'})
,new InsertExpression('`achievement_class_srl`', ${'achievement_class_srl3_argument'})
,new InsertExpression('`achievement_title`', ${'achievement_title4_argument'})
,new InsertExpression('`achievement_owner`', ${'achievement_owner5_argument'})
,new InsertExpression('`achievement_woncheongsa`', ${'achievement_woncheongsa6_argument'})
,new InsertExpression('`achievement_position`', ${'achievement_position7_argument'})
,new InsertExpression('`achievement_start_date`', ${'achievement_start_date8_argument'})
,new InsertExpression('`achievement_end_date`', ${'achievement_end_date9_argument'})
));
